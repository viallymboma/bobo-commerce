  ...
  return (
    <header className='backdrop-blur-lg border-gray-500 border-y-[1px] w-full p-5 fixed z-10'>
        <nav className='flex flex-row justify-between'>
            ...
            <div onClick={ openCartDisplay } className='relative'>
              {
                state?.selectedItems.length > 0 && 
                  <div className='bg-blue-600 text-white absolute text-[12px] font-bold right-[-15%] top-[-15%] py-0 px-[.3rem] rounded-lg'>
                    {/* 10 */}
